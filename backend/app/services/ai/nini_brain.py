...
ИСКЛЮЧЕНИЯ: сон, еда, перерыв — задачи создавать не нужно, просто запомни когда не беспокоить.
Если Давит говорит "не трогай меня N часов" или "буду спать" — НЕ создавай задачу, НЕ пингуй.
